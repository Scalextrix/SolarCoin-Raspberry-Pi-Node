...
pi@raspberrypi:~ $ solarcoind getinfo
...
pi@raspberrypi:~ $ solarcoind getblockcount
...
pi@raspberrypi:~ $ solarcoind getbalance
...
pi@raspberrypi:~ $ solarcoind walletpassphrase your_passphrase_here 300
...
To send the coins:
pi@raspberrypi:~ $ solarcoind sendtoaddress 8cESoZyjFvx2Deq6VjQLqPfAwu8UXjcBkK 1
...
pi@raspberrypi:~ $ solarcoind walletpassphrase your_passphrase_here 30000
...
pi@raspberrypi:~ $ solarcoind walletlock
...
The command is:
pi@raspberrypi:~ $ solarcoind walletpassphrase your_passphrase_here 9999999 true
...
you need to do:
pi@raspberrypi:~ $ solarcoind walletlock                                          (your wallet was UNLOCKED for staking, so first you must lock it)
pi@raspberrypi:~ $ solarcoind walletpassphrase your_passphrase_here 300           (fully unlock for 5 minutes, to allow the transaction)
pi@raspberrypi:~ $ solarcoind sendtoaddress 8cESoZyjFvx2Deq6VjQLqPfAwu8UXjcBkK 1  (send me 1 SLR)
pi@raspberrypi:~ $ solarcoind walletlock                                          (lock the wallet again, or you could just wait 5 minutes)
pi@raspberrypi:~ $ solarcoind walletpassphrase your_passphrase_here 9999999 true  (unlock the wallet for staking again)
...
pi@raspberrypi:~ $ solarcoind getnewaddress
...
pi@raspberrypi:~ $ solarcoind listunspent
...
pi@raspberrypi:~ $ solarcoind checkwallet
or
pi@raspberrypi:~ $ solarcoind repairwallet
...
pi@raspberrypi:~ $ solarcoind backupwallet /destination/directory/of/your/choice
